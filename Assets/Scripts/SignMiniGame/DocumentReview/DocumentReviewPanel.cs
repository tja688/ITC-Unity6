...
namespace ITC.SignMiniGame
{
    public sealed class DocumentReviewPanel : UIPanel, IController
    {
        ...
        private void EnsurePanelConfig()
        {
            ...
            {
                panelData.RuntimeConfig = this.GetModel<SignMiniGameClientConfigModel>().DocumentReviewRuleConfig;
            }

            if (panelData.ClientConfig == null)
            {
                panelData.ClientConfig =
                    this.GetModel<SignMiniGameClientConfigModel>().GetDocumentReviewClientConfig(panelData.ClientId);
            }
        }
