...
namespace ITC.SignMiniGame
{
    public sealed class BeginDocumentReviewCommand : AbstractCommand
    {
        ...
        {
            var model = this.GetModel<SignMiniGameFlowStateModel>();
    ...
    public sealed class FinalizeClientContractCommand : AbstractCommand
    {
        ...
        protected override void OnExecute()
        {
            ...
            var tipAmount = ResolveTipAmount(
                ruleConfig,
                clientConfig != null ? clientConfig.SocialClass : SignMiniGameSocialClass.Worker,
                day,
        ...
        private static int ResolveTipAmount(
            SignMiniGameSettlementConfig ruleConfig,
            SignMiniGameSocialClass socialClass,
            int day,
            int clientId,
            int satisfaction)
        {
