...
[ReplicaShowcase("Text", "Rollup")]
[DisallowMultipleComponent]
[RequireComponent(typeof(RectTransform))]
public sealed class CounterRollupEffectHostBridge : MonoBehaviour, IReplicaShowcaseBridge
{
    [Header("Runtime")]
    ...
    [Header("Config")]
    [SerializeField] private CounterRollupEffectConfig mConfig;
    ...
    private CounterRollupEffectController mController;
    ...
    private void Awake()
    {
        ...
        {
            Debug.LogError("CounterRollupEffectHostBridge requires RectTransform.", this);
            enabled = false;
            return;
        }
    ...
    private void EnsureController()
    {
        ...
        mController = new CounterRollupEffectController();
    ...
    private void EnsureModel()
    {
        ...
        mModel = new CounterRollupEffectModel
        {
            StartValue = mStartValue,
            MinTarget = mMinTarget,
            MaxTarget = mMaxTarget,
            ChangeInterval = mChangeInterval
        };
    }
}
