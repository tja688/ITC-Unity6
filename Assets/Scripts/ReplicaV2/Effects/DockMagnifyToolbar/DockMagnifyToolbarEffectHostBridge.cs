...
[ReplicaShowcase("UI", "Dock")]
[DisallowMultipleComponent]
[RequireComponent(typeof(RectTransform))]
public sealed class DockMagnifyToolbarEffectHostBridge : MonoBehaviour, IReplicaShowcaseBridge
{
    [Header("Runtime")]
    ...
    [Header("Config")]
    [SerializeField] private DockMagnifyToolbarEffectConfig mConfig;

    [Header("Default Model")]
    [SerializeField] private DockMagnifyToolbarEffectModel mDefaultModel;
    ...
    private void Awake()
    {
        ...
        {
            Debug.LogError("DockMagnifyToolbarEffectHostBridge requires RectTransform.", this);
            enabled = false;
            return;
        }
    ...
    private void OnEnable()
    {
        ...
        if (mModel == null)
        {
            mModel = mDefaultModel != null ? mDefaultModel.Clone() : DockMagnifyToolbarEffectModel.CreateDefault();
        }
    ...
    private void EnsureController()
    {
        ...
        mController = new DockMagnifyToolbarEffectController();
