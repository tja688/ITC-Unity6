...
[ReplicaShowcase("Text", "Circular")]
[DisallowMultipleComponent]
[RequireComponent(typeof(RectTransform))]
public sealed class CircularTextEffectHostBridge : MonoBehaviour, IReplicaShowcaseBridge
{
    [Header("Runtime")]
    ...
    [Header("Config")]
    [SerializeField] private CircularTextEffectConfig mConfig;
    ...
    private CircularTextEffectController mController;
    ...
    private void Awake()
    {
        ...
        {
            Debug.LogError("CircularTextEffectHostBridge requires RectTransform.", this);
            enabled = false;
            return;
        }
    ...
    public void UpdateSpinDuration(float duration, bool animated = true)
    {
        EnsureModel();
        mModel.SpinDuration = duration;
        mController.SetModel(mModel.Clone(), animated);
    }
    ...
    private void EnsureController()
    {
        ...
        mController = new CircularTextEffectController();
    ...
    private void EnsureModel()
    {
        ...
        mModel = new CircularTextEffectModel
        {
            Text = mText,
            SpinDuration = mSpinDuration
        };
    }
}
