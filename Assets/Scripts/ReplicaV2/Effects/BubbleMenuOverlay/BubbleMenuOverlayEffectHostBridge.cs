...
[ReplicaShowcase("UI", "BubbleMenu")]
[DisallowMultipleComponent]
[RequireComponent(typeof(RectTransform))]
public sealed class BubbleMenuOverlayEffectHostBridge : MonoBehaviour, IReplicaShowcaseBridge
{
    [Header("Runtime")]
    ...
    [Header("Config")]
    [SerializeField] private BubbleMenuOverlayEffectConfig mConfig;

    [Header("Default Model")]
    [SerializeField] private BubbleMenuOverlayEffectModel mDefaultModel;
    ...
    private void Awake()
    {
        ...
        {
            Debug.LogError("BubbleMenuOverlayEffectHostBridge requires RectTransform.", this);
            enabled = false;
            return;
        }
    ...
    private void OnEnable()
    {
        ...
        if (mModel == null)
        {
            mModel = mDefaultModel != null ? mDefaultModel.Clone() : BubbleMenuOverlayEffectModel.CreateDefault();
        }
    ...
    private void EnsureController()
    {
        ...
        mController = new BubbleMenuOverlayEffectController();
