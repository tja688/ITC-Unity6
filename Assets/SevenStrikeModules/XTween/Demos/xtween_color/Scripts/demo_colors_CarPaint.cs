...
public class demo_colors_CarPaint : demo_base
{
    ...
    public Color col_Light_last;
    public Color col_Light_current;
    ...
    public override void Start()
    {
        ...
        LightMaterial = new Material(image.material);
        image.material = LightMaterial;
        col_Light_current = LightMaterial.GetColor("_LightColor");
    ...
    /// </summary>
    /// <param name="color"></param>
    public void SetTargetLightColor(Color color)
    {
        XTween.To(() => col_Light_current, x => col_Light_current = x, color, duration, true).OnUpdate<Color>((d, v, f) =>
        {
            LightMaterial.SetColor("_LightColor", d);
        }).SetEase(easeMode).Play();
    }
    #endregion  
}