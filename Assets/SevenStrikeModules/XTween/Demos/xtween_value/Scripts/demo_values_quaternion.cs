...
public class demo_values_quaternion : demo_base
{
    ...
    public Text text_z;
    public Text text_w;
    public Vector4 value_current;
    public Vector4 value_target;
