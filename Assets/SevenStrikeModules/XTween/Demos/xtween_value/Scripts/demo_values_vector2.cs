...
public class demo_values_vector2 : demo_base
{
    ...
    public Text text_x;
    public Text text_y;
    public Vector2 value_current;
    public Vector2 value_target;
    ...
    #region 辅助
    public void QuaContentSet(Vector2 val)
    {
