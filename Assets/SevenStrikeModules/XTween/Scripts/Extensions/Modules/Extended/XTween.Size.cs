...
namespace SevenStrikeModules.XTween
{
    ...
    public static partial class XTween
    {
        ...
        public static XTween_Interface xt_Size_To(this UnityEngine.RectTransform rectTransform, Vector2 endValue, float duration, bool isRelative = false, bool autokill = false, bool rewind_set_startvalue = true, bool complete_set_endvalue = true)
        {
        ...
        /// <returns>创建的动画对象</returns>
        public static XTween_Interface xt_Size_To(this UnityEngine.RectTransform rectTransform, Vector2 endValue, float duration, bool isRelative, bool autokill, EaseMode easeMode, bool isFromMode, XTween_Getter<Vector2> fromvalue, bool useCurve, AnimationCurve curve)
        {
            if (rectTransform == null)
            {
                Debug.LogError("RectTransform is null!");
