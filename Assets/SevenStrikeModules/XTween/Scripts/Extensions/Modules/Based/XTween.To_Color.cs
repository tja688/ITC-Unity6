...
namespace SevenStrikeModules.XTween
{
    ...
    public static partial class XTween
    {
        ...
        public static XTween_Interface To(XTween_Getter<Color> getter, XTween_Setter<Color> setter, Color endValue, float duration, bool autokill = true, bool rewind_set_startvalue = true)
        {
        ...
        /// <returns>创建的动画对象</returns>
        public static XTween_Interface To(XTween_Getter<Color> getter, XTween_Setter<Color> setter, Color endValue, float duration, bool autokill, EaseMode easeMode, bool isFromMode, XTween_Getter<Color> fromvalue, bool useCurve, AnimationCurve curve)
        {
            Color startValue = getter();
