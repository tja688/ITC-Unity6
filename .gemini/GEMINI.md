...
- For implementation details, always read and follow:
  - `./.gemini/skills/qframework-architecture/SKILL.md`

### 6.2 Three Key Scenarios Must Use Corresponding QF Skills
- `res` scenario -> `./.gemini/skills/qframework-reskit/SKILL.md`
- `audio` scenario -> `./.gemini/skills/qframework-audiokit/SKILL.md`
- `ui` scenario -> `./.gemini/skills/qframework-uikit/SKILL.md`
